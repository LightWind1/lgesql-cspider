...
def add_argument_encoder(arg_parser):
    ...
    arg_parser.add_argument('--plm', type=str, choices=['bert-base-uncased', 'bert-large-uncased', 'bert-large-uncased-whole-word-masking','chinese-bert-wwm-ext',
        'roberta-base', 'roberta-large', 'grappa_large_jnt', 'electra-base-discriminator', 'electra-large-discriminator','chinese-electra-large-discriminator'], help='pretrained model name')
