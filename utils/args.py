...
def add_argument_encoder(arg_parser):
    ...
    arg_parser.add_argument('--plm', type=str, choices=['bert-large-uncased-whole-word-masking','electra-large-discriminator','bert-base-multilingual-uncased'], help='pretrained model name')
